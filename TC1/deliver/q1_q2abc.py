...
if PB_filt:
    ...
    for cut_freq_lp in [22,32,42]:
        ...
        plt.legend()
    plt.savefig('../images/Q2a4_freqs_corte.png')
...
if PA_filt:
    ...
    plt.savefig('../images/Q2_b_filtro_PA_respfreq.png')
    ...
    if plotQ2b:
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('../images/Q2_b_sinal_filt_PA.png')
        ...
        plt.legend()
        plt.tight_layout()
        plt.savefig('../images/Q2_b_espectro_filt_PA_comparativo.png')
    ...
    for i,cut_freq_hp in enumerate([0.1,0.5,5.0]):
        ...
        plt.legend()
    plt.savefig('../images/Q2b4_freqs_corte.png')
...
if Notch_filt:
    ...
    if plotQ2c:
        ...
        plt.grid(b=True,which='both')
        plt.tight_layout()
        plt.savefig('../images/Q2_c_sinal_filt_Notch.png')
        ...
        plt.tight_layout()
        plt.savefig('../images/Q2_c_espectro_filt_Notch.png')
        ...
        plt.savefig('../images/Q2c_Notch_respfreq.png')
        ...
        plt.legend()
        #
        plt.savefig('../images/Q2c_comparativo_orig_notch.png')
